...
class VoidReasonDescription(SimpleText):
    def __init__(self, void_reason_description):
        super(VoidReasonDescription, self).__init__(void_reason_description, "sac:VoidReasonDescription")
...
class VoidedDocumentsLine(Xmleable):
    ...
    def fix_values(self):
        ...
        if type(self.void_reason_description) == str:
            self.void_reason_description = VoidReasonDescription(self.void_reason_description)
