...
class NotaDebito:
    ...
    def RequestedMonetaryTotal(self, payable_amount,currencyID):
    ...
    def DebitNoteLine(self,ID,unitCode,quantity,currencyID,amount,
    ...
    def cacInvoiceLine(self, ID, unitCode, quantity, currencyID, amount):
        ...
        cacInvoiceLine = self.doc.createElement('cac:DebitNoteLine')
        ...
        cbcInvoiceQuantity = self.doc.createElement('cbc:DebitedQuantity')
