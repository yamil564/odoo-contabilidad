...
class Status(Xmleable):
    ...
    def generate_doc(self):
        ...
        self.doc.appendChild(createElementContent("cbc:ConditionCode", self.condition_code))
...
class SummaryDocumentsLine(Xmleable):
    ...
    def validate(self, errs, obs):
        ...
        assert type(self.accounting_customer_party) in [None, AccountingCustomerParty]
