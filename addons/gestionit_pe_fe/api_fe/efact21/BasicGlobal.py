...
class UBLVersion(Xmleable):
    ...
    def generate_doc(self):
        self.doc = createElementContent('cbc:UBLVersionID', self.ubl_version_id)
...
class CustomizationID(Xmleable):
    ...
    def generate_doc(self):
        self.doc = createElementContent('cbc:CustomizationID', str(self.customization_id))
...
class DocumentCurrencyCode(Xmleable):
    ...
    def generate_doc(self):
        self.doc = createElementContent('cbc:DocumentCurrencyCode', self.document_currency_code)
        self.doc.setAttribute('listID', self.listID)
        self.doc.setAttribute('listName', self.listName)
        self.doc.setAttribute('listAgencyName', self.listAgencyName)
...
class DocumentNumberID(SimpleText):
    def __init__(self, number_id):
        super(DocumentNumberID, self).__init__(number_id, "sac:DocumentNumberID")

class DocumentSerialID(SimpleText):
    def __init__(self, serial_id):
        super(DocumentSerialID, self).__init__(serial_id, "sac:DocumentSerialID")

class DocumentTypeCode(SimpleText):
    def __init__(self, type_code):
        super(DocumentTypeCode, self).__init__(type_code, "cbc:DocumentTypeCode")


class DespatchAdviceTypeCode(SimpleText):
    def __init__(self, type_code):
        super(DespatchAdviceTypeCode, self).__init__(type_code, "cbc:DespatchAdviceTypeCode")
...
class RegistrationName(Xmleable):
    ...
    def generate_doc(self):
        self.doc = createCDataContent("cbc:RegistrationName", self.registration_name)
