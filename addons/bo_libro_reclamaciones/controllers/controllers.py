...
class CustomLibroReclamaciones(http.Controller):
    ...
    def LibroReclamacionesEnviada(self,code, **kw):
        return request.render('bo_libro_reclamaciones.reclamacion_enviada',{"code":code})
    ...
    def LibroReclamaciones(self, **args):
        ...
        state_ids = request.env['res.country.state'].sudo().search([('country_id', '=', country_id), ('state_id', '=', False), ('province_id', '=', False)])
